...
contract Setup is Test, ERC721Holder {
    RdpxV2Core public rdpxV2Core;
    RdpxV2Bond public rdpxV2Bond;
    PerpetualAtlanticVault public vault;
    PerpetualAtlanticVaultLP public vaultLp;
    RdpxDecayingBonds public rdpxDecayingBonds;
    MockToken public weth;
    MockToken public rdpx;
    DpxEthToken public dpxETH;
    MockVolatilityOracle public volatilityOracle;
    MockOptionPricing public optionPricing;
    MockRdpxEthPriceOracle public rdpxPriceOracle;
    MockDpxEthPriceOracle public dpxEthPriceOracle;
    MockRdpxV2ReceiptToken public rdpxV2ReceiptToken;
    RdpxReserve public rdpxReserveContract;
    ReLPContract public reLpContract;
    ...
    function setUp() public {
        ...
        vm.label(address(rdpx),"rdpx: rebate ");
        
        dpxETH = new DpxEthToken();
        vm.label(address(dpxETH),"dpxETH: ");

        console.log("deployed dpxETH:: ", address(dpxETH));
